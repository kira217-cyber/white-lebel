...
const MyGpAddProvider = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      fd.append("isHome", String(Boolean(form.isHome)));
      ...
      if (editing?._id) {
        await api.put(`/api/master/mygp-game-providers/${editing._id}`, fd, {
          headers: {
        ...
        await api.post("/api/master/mygp-game-providers", fd, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        });
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await api.delete(`/api/master/mygp-game-providers/${id}`);
    ...
    <div className="space-y-6 text-white">
        ...
        <div className="relative flex flex-col justify-between gap-5 lg:flex-row lg:items-center">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-slate-300">
              Add Oracle providers under MyGP categories from the master panel.
      ...
      >
        <div className="rounded-[32px] border border-white/10 bg-white/[0.06] p-5 shadow-2xl md:p-6">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              ...
              >
                <option className="bg-[#030712]" value="">
                  {oracleLoading
                    ? "Loading providers..."
                    : "Choose provider from full list..."}
                </option>
            ...
            <ToggleCard
              title="Show On Home"
              subtitle="Display this provider on home section"
              checked={form.isHome}
              icon={Home}
              onChange={(value) =>
                setForm((prev) => ({
      ...
      <section className="rounded-[32px] border border-white/10 bg-white/[0.06] p-5 shadow-2xl md:p-6">
        <div className="mb-5 flex flex-col justify-between gap-4 xl:flex-row xl:items-center">
          <div>
            <h2 className="text-xl font-black">MyGP Providers</h2>
          ...
          <div className="grid gap-3 md:grid-cols-[1fr_180px_140px_130px_130px_120px]">
            <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-black/30 px-4 py-3">
              <Search className="h-5 w-5 text-cyan-300" />
...
export default MyGpAddProvider;
